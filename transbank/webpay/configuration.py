...
class Configuration(object):
    def __init__(self, private_key = None, public_cert = None, webpay_cert = None, commerce_code = None, environment = None, store_codes = None):
        self.private_key = private_key
        self.public_cert = public_cert
        self.webpay_cert = webpay_cert
        self.commerce_code = commerce_code
        self.environment = environment
        self.store_codes = store_codes

    @classmethod
    def for_testing_webpay_plus_normal(cls):
        configuration = Configuration()
        configuration.environment = DEVELOPMENT
        configuration.commerce_code = "597020000540"
        configuration.private_key = """-----BEGIN RSA PRIVATE KEY-----
...
-----END RSA PRIVATE KEY-----"""
        configuration.public_cert = """-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----"""
    ...
    @classmethod
    def for_testing_webpay_plus_capture(cls):
        configuration = Configuration()
        configuration.environment = DEVELOPMENT
        configuration.commerce_code = "597044444404"
        configuration.private_key = """-----BEGIN RSA PRIVATE KEY-----
...
-----END CERTIFICATE-----"""
    ...
    @classmethod
    def for_testing_webpay_plus_mall(cls):
        configuration = Configuration()
        configuration.environment = DEVELOPMENT
        configuration.commerce_code = "597044444401"
        configuration.private_key = """-----BEGIN RSA PRIVATE KEY-----
...
-----END CERTIFICATE-----"""
    ...
    @classmethod
    def for_testing_webpay_oneclick_normal(cls):
        configuration = Configuration()
        configuration.environment = DEVELOPMENT
        configuration.commerce_code = "597044444405"
        configuration.private_key = """-----BEGIN RSA PRIVATE KEY-----
...
-----END CERTIFICATE-----"""
    ...
    @classmethod
    def for_testing_patpass_by_webpay_normal(cls, commerce_mail):
        configuration = Configuration()
        configuration.environment = DEVELOPMENT
        configuration.commerce_code = "597020000548"
        configuration.private_key = """-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----"""
        configuration.public_cert = """-----BEGIN RSA PRIVATE KEY-----
...
-----END RSA PRIVATE KEY-----"""
        configuration.commerce_mail = commerce_mail
        return configuration
